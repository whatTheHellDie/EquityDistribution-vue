<template>
  ...
  <div class="pay-img">
    ...
    <div class="gou-wrap">
        <img src="/static/img/cha1.png" class="gou" />
    </div>
    <div class="gou-wrap gou-wrap1">
        <img src="/static/img/cha2.png" class="gou" />
    </div>
   支付失败
  </div>
  </div>
  ...
  export default {
    ...
    mounted() {
      ...
      var rander = function() {
        ...
        if(percent == 100) {
          var gou=document.querySelectorAll(".gou-wrap");
          gou[0].classList.add("active")
          setTimeout(function(){
            gou[1].classList.add("active")
          },1000)
        }
    ...
    deactivated(){
      ctx.clearRect(0, 0, mW, mH); 
      var gou=document.querySelectorAll(".gou-wrap");
      gou[0].classList.remove("active")
      gou[1].classList.remove("active")
    }
  }
</script>
